...
const ProfessionalPromise = () => {
    return <div>
        <Navbar></Navbar>
        <ProfessionalPromise2 />
    </div>
}

const ProfessionalPromise2 = () => {
    ...
    return (
        <div>
            {/* <Navbar></Navbar> */}
            <p className='text-[22px] lg:text-3xl text-center mb-6 mt-14'>Professional Promise</p>
...
export default ProfessionalPromise;