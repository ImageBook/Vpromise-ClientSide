                ...
                <div className='w-11/12 sm:w-5/6 md:w-3/5 mx-auto border rounded-lg p-4 bg-gray-100'>
                    <form onSubmit={handleSubmit(onSubmit)} className='flex flex-col items-center justify-center'>
                        <div className='flex flex-col items-start mb-1'>
                            ...
                            <input onChange={(e) => console.log(e.target.value)} className='w-[300px] md:w-[350px] lg:w-[400px] h-14 bg-white px-3 py-2 mb-3 rounded-lg focus:outline-none' type="text" name="title" placeholder='Title' required />
                        </div>
                        <div className='flex flex-col items-start mb-1'>
                            <p className='font-light mb-1'>Due date</p>
                            <input onChange={(e) => setDate(e.target.value)} className='w-[300px] md:w-[350px] lg:w-[400px] h-14 bg-white px-3 py-2 mb-3 rounded-lg focus:outline-none' type="date" name="date" placeholder='Due Date' />
                        </div>
                        <div className='flex flex-col items-start mb-1'>
                            <p className='font-light mb-1'>Notes</p>
                            <textarea onChange={(e) => setNotes(e.target.value)} className='w-[300px] md:w-[350px] lg:w-[400px] h-32 bg-white px-3 py-2 mb-3 rounded-lg focus:outline-none' type="text" name="notes" placeholder='Notes' />
                        </div>
